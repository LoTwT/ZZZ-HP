...
**当前推荐发布线**：`3.1.6`（已合入 `3.1.6.3` 尖端；站点更新日志版本 **3.1.7**）。  
**当前开发线**：`3.1.6.3`（继续迭代；**保留**本分支；已含远程 `3.1.6.4` 招式流程 + 分数血量转换器，**保留** `3.1.6.4`；package `3.1.7`）。  
...
| **package** | `3.1.7` |
| **分支关系** | **已并回** `3.1.6`（发布线）；**本分支保留**继续开发。尖端**已含远程** `origin/3.1.6.4`（招式流程覆盖合入 + 分数血量转换器）；**保留** `3.1.6.4`。站点更新日志版本 **3.1.7** |
| **合入要点** | |
