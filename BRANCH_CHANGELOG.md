...
**当前开发线**：`3.1.6.3`（继续迭代；**保留**本分支；已含远程 `3.1.6.4` 招式流程 + 分数血量转换器，**保留** `3.1.6.4`）。  
...
| **package** | `3.1.6.3` |
| **分支关系** | **已并回** `3.1.6`（发布线）；**本分支保留**继续开发。尖端**已含远程** `origin/3.1.6.4`（招式流程覆盖合入 + 分数血量转换器）；**保留** `3.1.6.4` |
| **合入要点** | |
...
| 3.1.6.3 | handoff1 + 招式流程 / 分数血量转换器 + 计算器构图与切换性能 |
